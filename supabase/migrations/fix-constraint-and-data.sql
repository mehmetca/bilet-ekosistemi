-- Events tablosunun check constraint'ini kontrol et
...
-- Events tablosunun category değerlerini kontrol et
SELECT DISTINCT category FROM public.events;

-- Geçerli category değerleri
-- Constraint'i güncelle veya doğru değerleri kullan
-- Muhtemelen kabul edilen değerler: 'konser', 'tiyatro', 'sinema', 'festival', 'spor', 'diger'

-- Doğru category değerleri ile data ekle
INSERT INTO public.events (
  ...
  (
    ...
    'diger', -- stand-up yerine 'diger' kullan
    true
  ),
  (
    'Tiyatro: Oyuncular',
