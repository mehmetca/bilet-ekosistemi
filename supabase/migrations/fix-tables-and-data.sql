-- Events tablosu structure kontrolü
...
-- Events tablosuna is_active column'u ekle (yoksa)
ALTER TABLE public.events 
ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT true;

-- created_at ve updated_at column'larını kontrol et ve ekle
ALTER TABLE public.events 
...
-- News tablosuna eksik column'ları ekle
