-- Update function to handle NULL buyer_name and buyer_email
...
BEGIN
  INSERT INTO public.orders (
    ...
    COALESCE(NULLIF(TRIM(p_buyer_name), ''), 'Bilet Alıcı'),
    COALESCE(NULLIF(TRIM(p_buyer_email), ''), 'bilinmiyor@example.com')
  );
END;
$$;
