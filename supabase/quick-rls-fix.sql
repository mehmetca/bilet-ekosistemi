-- Quick RLS Performance Fix - Only Problematic Policies
-- This script only fixes policies that have performance issues

-- Fix artists table admin policies
...
-- Fix events table admin policies
...
-- Fix tickets table admin policies
...
-- Fix orders table admin policies
...
-- Fix tour_events table admin policies
