-- Complete Database Reset for Orders Table
-- This script recreates the orders table to fix all schema cache issues
...
-- 3. Recreate orders table with all required columns
