...
VALUES 
  ('GERÇEK_ARTIST_ID_BURAYA', 'Berlin', 'Mercedes-Benz Arena', '2026-03-27T20:00:00', 57.75, 'https://eventim.de/event/mem-ararat-berlin'),
  ('GERÇEK_ARTIST_ID_BURAYA', 'Hamburg', 'Barclaycard Arena', '2026-03-29T20:00:00', 62.50, 'https://eventim.de/event/mem-ararat-hamburg'),
  ('GERÇEK_ARTIST_ID_BURAYA', 'Münih', 'Olympiahalle', '2026-04-01T20:00:00', 65.00, 'https://eventim.de/event/mem-ararat-munich'),
  ('GERÇEK_ARTIST_ID_BURAYA', 'Köln', 'Lanxess Arena', '2026-04-03T20:00:00', 59.00, 'https://eventim.de/event/mem-ararat-koln'),
  ('GERÇEK_ARTIST_ID_BURAYA', 'Frankfurt', 'Festhalle', '2026-04-05T20:00:00', 61.25, 'https://eventim.de/event/mem-ararat-frankfurt');
