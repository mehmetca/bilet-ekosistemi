          ...
          {step === "sent" && (
            <div className="py-4">
              ...
              <div className="rounded-lg bg-slate-50 border border-slate-200 p-4 text-sm text-slate-700 mb-6">
                <p className="font-medium text-slate-800 mb-2">Bilet Ekosistemi</p>
                <p className="mb-2">
                  Bu e-posta, Bilet Ekosistemi hesabınız için şifre sıfırlama talebiniz üzerine gönderilmiştir.
