...
export default function MekanDetailClient({
  initialVenue,
  venueId,
}: {
  initialVenue: Record<string, unknown> | null;
  venueId: string;
}) {
  ...
  const venueName = localized.name || (venueRaw.name as string | null) || venueIdResolved;
          ...
          <div className="mt-6">
            ...
            <div className="w-full aspect-video overflow-hidden rounded-2xl border border-slate-200 bg-white">
              <iframe
                ...
                title={`${localized.name || venueIdResolved} ${t("map")}`}
