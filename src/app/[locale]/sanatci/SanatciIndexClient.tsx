...
function SanatciIndexContent({ initialArtists }: { initialArtists: Artist[] }) {
...
export default function SanatciIndexClient({ initialArtists }: { initialArtists: Artist[] }) {
  return (
    <Suspense fallback={<ArtistsLoadingFallback />}>
      <SanatciIndexContent initialArtists={initialArtists} />
    </Suspense>
  );
}
