...
export default function ArtistPageClient({ artist, slug }: ArtistPageClientProps) {
  ...
  // Tum yaklasan etkinliklerden rastgele 3 adet cek (sayfa/sanatci degisince farkli secim)
  useEffect(() => {
    let cancelled = false;
  ...
  const localized = artist
    ? getLocalizedArtist(artist as unknown as Record<string, unknown>, locale)
    : { name: "", bio: "" };
                          ...
                          <div className="space-y-1 text-sm text-slate-600">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="line-clamp-1">
                                {localizedEvent.venue || event.venue}, {event.location}
                              </span>
                            </div>
                          </div>
